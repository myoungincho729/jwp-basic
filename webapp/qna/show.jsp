				...
				<article class="article">
					...
					<div class="article-util">
						<ul class="article-util-list">
							...
							<li>
								<form class="form-delete delete-question" action="/qna/delete?questionId=${question.questionId}" method="POST">
								...
								<article class="article">
									...
									<div class="article-util">
										<ul class="article-util-list">
											...
											<li>
												<form class="form-delete delete-answer" action="/api/qna/deleteAnswer" method="POST">
